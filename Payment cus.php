...
<link rel="stylesheet" href="Payment cus.css" type="text/css">
	</head>
<body>
	<button type="button" onClick="location.href='Home.php'" id="b2">Home</button>
	<h1>Payment Mode</h1>
	<hr>
	<form class="box" action="Payment cus.php" method="post">
	...
	if($submit && isset($_POST['debit']))
	{
		...
		$query1="INSERT INTO payment (payment_mode,card_no,cvv,expiry_date,name,amount,payment_id,sender_id,receiver_id)
		VALUES ('$debit','$cno','$cvv','$exp','$cname','$amt','$pid','$sid1','$rid1')";
	...
	{
		mysqli_select_db($conn,$db);
		$query2="INSERT INTO payment (payment_mode,card_no,cvv,expiry_date,name,amount,payment_id,sender_id)
		VALUES ('$credit','$cno','$cvv','$exp','$cname','$amt','$pid','$sid1')";
